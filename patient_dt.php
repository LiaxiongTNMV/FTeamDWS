...
<body>
<div class="jumbotron" style="background: url(image/patient.jpg) no-repeat; background-size:cover; height:450px; "></div>
<div class="container">
<div class="card">
		...
		<div class="col-md-3"><h3>Patients Details</h3></div>
